...
import ReservationCollector from './components/ReservationCollector'
import Settings from './components/Settings'

function App() {
    const [currentTab, setCurrentTab] = useState<'dashboard' | 'education' | 'reservation' | 'settings' | 'member'>('education')
    ...
    return (
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="flex-1 overflow-hidden">
                ...
                {currentTab === 'member' && <MemberManager />}
